...
* Add more than one moving guards, and render their visible areas transparently, so that the overlap is easy to see, like so:  ![demo1](guard-demo-di.mov) ![demo2](guard-demo-di.mov)
